...
/* Definition for USART3 clock resources */
#define USART4_CLK_ENABLE()              __USART4_CLK_ENABLE()
#define USART4_RX_GPIO_CLK_ENABLE()      __GPIOB_CLK_ENABLE()
#define USART4_TX_GPIO_CLK_ENABLE()      __GPIOB_CLK_ENABLE()

#define USART4_FORCE_RESET()             __USART4_FORCE_RESET()
#define USART4_RELEASE_RESET()           __USART4_RELEASE_RESET()

/* Definition for USARTx Pins */
#define USART4_TX_PIN                    GPIO_PIN_9
#define USART4_TX_GPIO_PORT              GPIOB
#define USART4_TX_AF                     GPIO_AF8_UART4
#define USART4_RX_PIN                    GPIO_PIN_8
#define USART4_RX_GPIO_PORT              GPIOB
